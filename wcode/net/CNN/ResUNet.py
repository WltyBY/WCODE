...
from wcode.net.CNN.modules.baseblocks import ResidualBlock, ConvBlock
from wcode.net.CNN.modules.pooling import ConvDownPool, ConvUpPool
...
if __name__ == "__main__":
    ...
    data = open_yaml("./wcode/net/examples/ResUNet_test.yaml")
