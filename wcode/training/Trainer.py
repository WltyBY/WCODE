...
class PatchBasedTrainer(object):
    ...
    def get_train_settings(self, training_setting_dict):
        ...
        self.fold = training_setting_dict["fold"]
    ...
    def train_end(self):
        ...
        if os.path.isfile(os.path.join(self.logs_output_folder, "checkpoint_latest.pth")):
    ...
    def validation_epoch_end(self, val_outputs):
        ...
        self.logger.log(
            "dice_per_class", global_dc_per_class, self.current_epoch
        )
...
if __name__ == "__main__":
    ...
    Trainer = PatchBasedTrainer(settings_path)
