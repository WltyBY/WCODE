...
if __name__ == "__main__":
    # file_path_lst = ["./Prediction/fold_0/validation/summary.json"]

    base = "./Prediction/"
    file_path_lst = [
        base+"/fold_0/validation/summary.json",
        base+"/fold_1/validation/summary.json",
        base+"/fold_2/validation/summary.json",
        base+"/fold_3/validation/summary.json",
        base+"/fold_4/validation/summary.json",
    ]
