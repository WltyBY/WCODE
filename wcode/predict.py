...
parser.add_argument(
    "-o",
    type=str,
    default="./Logs/LNQ2023/LNQ2023_DBDMP/tversky_alpha_0.4_sce_alpha_0.8_w_class_[1.2, 0.8]_lambda_for_plabel_2.0_rampup_epoch_100/fold_0/testing_final",
    help="folder path of save path",
)
parser.add_argument(
    "-m",
    type=str,
    default="./Logs/LNQ2023/LNQ2023_DBDMP/tversky_alpha_0.4_sce_alpha_0.8_w_class_[1.2, 0.8]_lambda_for_plabel_2.0_rampup_epoch_100/fold_0/checkpoint_final.pth",
